...
def test_long_compare():
    alert1 = NRPEData(juju_model="openstack", juju_unit="octavia",
                      alert_check_name="lbs", alert_state=0, alert_time=42)
    alert2 = NRPEData(juju_model="openstack", juju_unit="n-c-c",
                      alert_check_name="VMs", alert_state=1, alert_time=43)
    alert3 = NRPEData(juju_model="openstack2", juju_unit="n-c-c",
                      alert_check_name="VMs", alert_state=1, alert_time=43)
    alert4 = NRPEData(juju_model="openstack", juju_unit="keystone",
                      alert_check_name="Idunno", alert_state=0, alert_time=43)
    alert1repeat = NRPEData(juju_model="openstack", juju_unit="octavia",
